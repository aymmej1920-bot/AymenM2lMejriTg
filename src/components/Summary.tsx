    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {kpis.map((kpi, index) => {
          const Icon = kpi.icon;
          return (
            <div key={index} className={`bg-gradient-to-br ${kpi.color} text-white rounded-xl shadow-lg p-6 glass hover-lift`}>
      ...
      <div className="glass rounded-xl shadow-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="text-center p-4 bg-blue-50 rounded-lg glass-effect">
          ...
          <div className="text-center p-4 bg-green-50 rounded-lg glass-effect">
          ...
          <div className="text-center p-4 bg-orange-50 rounded-lg glass-effect">
          ...
          <div className="text-center p-4 bg-purple-50 rounded-lg glass-effect">
