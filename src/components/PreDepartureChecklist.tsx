                ...
                <div className="flex space-x-4">
                  <div className="flex items-center space-x-1">
                    <input
                      ...
                      className="h-4 w-4 text-green-600 bg-white border border-gray-600 shadow-sm focus:ring-green-500"
                      disabled={!canAdd}
                    />
                  ...
                  <div className="flex items-center space-x-1">
                    <input
                      ...
                      value="false"
                      {...register('tire_pressure_ok')}
                      className="h-4 w-4 text-red-600 bg-white border border-gray-600 shadow-sm focus:ring-red-500"
                      disabled={!canAdd}
                    />
