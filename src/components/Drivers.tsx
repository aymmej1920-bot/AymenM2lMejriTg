...
const Drivers: React.FC<DriversProps> = ({ data, onUpdate }) => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const newData = editingDriver
      ? {
          ...data,
          drivers: data.drivers.map(d => d.id === editingDriver.id ? driverData : d)
        }
      : {
          ...data,
          drivers: [...data.drivers, driverData]
        };
