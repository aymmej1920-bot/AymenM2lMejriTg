...
function App() {
  ...
  if (isLoading || dataLoading) {
    return (
      <div className="min-h-screen bg-indigo-50 flex flex-col"> {/* Changed from bg-gray-50 */}
  ...
  return (
    <div className="min-h-screen bg-indigo-50"> {/* Changed from bg-gray-50 */}
      <header className="bg-gradient-to-r from-purple-600 to-blue-600 text-white shadow-lg">
        <div className="container mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
                ...
                <button
                  ...
                  className={`px-6 py-4 rounded-lg whitespace-nowrap transition-all duration-300 flex items-center space-x-2 ${
                    currentTab === tab.id
                      ...
                      : 'bg-indigo-100 hover:bg-indigo-200 text-gray-700' // Changed inactive tab colors
                  }`}
                >
